...
namespace CompanyManagement.Spec
{
    public class EmployeeSpecificationTests
    {
        ...
        public void CalculateMonthlySalary(int hoursWorkedDuringTheWeek, int hoursWorkedOntheWeekend, int hoursWorkedOnHolidays,
            decimal expectedSalaryForWeekHours, decimal expectedSalaryWithWeekendHours, decimal expectedTotalSalary)
        {
        ...
        [Scenario(Skip = "This Scenario is skipped")]
        public void SkippedScenario()
        {
            // implement test here and remove skip
        }
    }
}